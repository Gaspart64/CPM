...
;(function () {
  ...
  function expandConfig (config) {
    ...
    if (!config.hasOwnProperty('pieceTheme') ||
      ...
      config.pieceTheme = 'src/lib/chessboardjs/img/chesspieces/wikipedia/{piece}.svg'
    }
  ...
  function constructor (containerElOrString, config) {
    ...
    function calculateSquareSize () {
        ...
        // --------------------------------------------------------
        // -- Added code to handle height

        // Get the viewable height (minus a small buffer) so that the board doesn't grow beyond the height of the screen
        var containerHeight = parseInt($(window.top).innerHeight() - 50, 10);
        
        // Set the containerWidth to the smaller of these two values
